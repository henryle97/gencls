...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_dir', type=str, required=True,
                        help='Directionary path of images')
    ...
    parser.add_argument('--threshold', type=float,
                        help='threshold for confuse case')
    ...
    for class_name in class_dict.keys():
        ...
        confuse_dir = osp.join(args.out_dir, class_name + "_confuse")
    ...
    for item in results:
        ...
        if scores <= args.threshold:
            out_dir = osp.join(
                args.out_dir, item['label_name_list'][0] + "_confuse")
        else:
